# Generated by Django 2.2.3 on 2019-07-28 06:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salons', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='home.Salons')),
            ],
        ),
        migrations.CreateModel(
            name='Products',
            fields=[
                ...
                ('salons', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='home.Salons')),
            ],
        ),
        migrations.CreateModel(
            name='Likes',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('salon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='salon_likes', to='home.Salons')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
            fields=[
                ...
                ('salon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='home.Salons')),
            ],
        ),
        migrations.CreateModel(
            name='Appointments',
            fields=[
                ...
                ('client', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='my_appointments', to=settings.AUTH_USER_MODEL)),
                ('salons', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='home.Salons')),
