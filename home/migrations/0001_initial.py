    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('cost', models.ImageField(max_length=50, upload_to='')),
                ('duration', models.CharField(max_length=20)),
                ('bookings', models.IntegerField()),
                ('availability', models.BooleanField(default=True)),
                ('salon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='home.Salon')),
            ],
        ),
        migrations.CreateModel(
            name='Products',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stars', models.CharField(choices=[('1 Star', '1 star'), ('2 Stars', '2 stars'), ('3 Stars', '3 stars'), ('4 Stars', '4 stars'), ('5 Stars', '5 stars')], default='1 star', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ManyToManyField(related_name='products', to='home.Products')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(default='M-Pesa', max_length=100)),
                ('salon', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='salon_subscriptions_salon', to='home.Salon')),
                ('who_payed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='salon_subscriptions_owner', to='home.Owner')),
            ],
        ),
        migrations.AddField(
            model_name='salon',
            name='owner',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='my_salons', to='home.Owner'),
        ),
    ]
