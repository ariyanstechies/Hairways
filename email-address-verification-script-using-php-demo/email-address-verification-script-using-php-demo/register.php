...
if(isset($_POST["register"]))
{
	...
	else
	{
		...
		if(isset($result))
		{
			...
			$mail->Host = 'mail.hairways.co.ke';		//Sets the SMTP hosts of your Email hosting, this for Godaddy
			$mail->Port = '465';								//Sets the default SMTP server port
			$mail->SMTPAuth = true;							//Sets SMTP authentication. Utilizes the Username and Password variables
			$mail->Username = 'info@hairways.co.ke';					//Sets SMTP username
			$mail->Password = 'WILLY@jay17kish05';					//Sets SMTP password
			$mail->SMTPSecure = '';							//Sets connection prefix. Options are "", "ssl" or "tls"
			$mail->From = 'info@hairways.co.ke';			//Sets the From email address for the message
			$mail->FromName = 'Hairways';					//Sets the From name of the message
